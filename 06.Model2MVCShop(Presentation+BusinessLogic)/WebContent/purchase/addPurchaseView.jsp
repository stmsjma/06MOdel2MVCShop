...
<%
	System.out.println("addPurchaseView.jsp started===>>>");
	
	User user=(User)session.getAttribute("user");

	System.out.println("addPurchaseView.jsp ==>> user id" + user.getUserId());
	...
	<tr>
		...
		<td class="ct_write01">
			<input 	type="text" name="quanity" class="ct_input_g" 
							style="width: 100px; height: 19px" maxLength="20" placeholder="수량을 입력하세요." />
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>

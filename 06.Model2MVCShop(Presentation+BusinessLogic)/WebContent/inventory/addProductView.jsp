...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 13px;">
	...
	<tr>
		<td width="104" class="ct_write">
			상품코드 <img src="/images/ct_icon_red.gif" width="3" height="3" align="absmiddle"/>
		</td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="quanity"	class="ct_input_g" 
	...
	<tr>
		...
		<tr>
		<td width="104" class="ct_write">
			창고코드 <img src="/images/ct_icon_red.gif" width="3" height="3" align="absmiddle"/>
		</td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="warehouse_code" 	class="ct_input_g" 
						style="width: 100px; height: 19px" maxLength="10">&nbsp;
		</td>
	</tr>
	<tr>
